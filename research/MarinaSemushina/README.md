...
# Полученные окончательные результаты:

Рассчитали метрики по дням, по магазинам, общую метрику по моделям
Для XGBoost
Общий RMSE: 15.2053
Общий R²: 0.8621

Написали функцию для подсчета коэффициента и рассчитали его для продаж по дням
