...
df = pd.read_csv('clean_data/data_clean.csv', parse_dates=['date'])
# df = pd.read_csv('data0/data_id.csv', parse_dates=['date'])
...
weather_features = [
    ...
    'temperature_diff', 'heavy_precip', 'max_temp_last_3_days' 'avg_temp_last_3_days',
